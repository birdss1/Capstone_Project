...
public class Flyaway {
	...
	public String[] exp_details() {
		...
		driver.findElement(By.xpath("//input[@name=\"email_id\"]")).sendKeys("shashank@shekhar.com");
		driver.findElement(By.xpath("//input[@name=\"pwd\"]")).sendKeys("shashank");
		driver.findElement(By.xpath("//button")).click();
		driver.findElement(By.linkText("Logout")).click();
		
		
		String exp_email="shashgu3@cisco.com";
		String exp_pwd ="shashank";
		String exp_name = "shashank gupta";
...
//		driver.close();
	...
	public int Login_SearchFlight_Validate() {
		...
		driver.get("http://localhost:8080/FlyAway/");
		driver.findElement(By.linkText("Login/Signup")).click();
		driver.findElement(By.xpath("//input[@name=\"email_id\"]")).sendKeys("shashgu3@cisco.com");
		driver.findElement(By.xpath("//input[@name=\"pwd\"]")).sendKeys("shashank");
		driver.findElement(By.xpath("//button")).click();
